...
(function () {
  ...
  const HS = {
    ...
    d_uketsuke: { img: "d_uketsuke", w: 64, h: 64, top: 6, bottom: 57 },
    d_shateki: { img: "d_shateki", w: 64, h: 64, top: 6, bottom: 58, solid: [24, 10] },
    d_yakisoba: { img: "d_yakisoba", w: 64, h: 64, top: 4, bottom: 60, solid: [24, 10] },
    d_carver: { img: "d_carver", w: 64, h: 64, top: 3, bottom: 61, solid: [28, 10] },
    d_band1: { img: "d_band1", w: 64, h: 64, top: 6, bottom: 58 },
    d_band2: { img: "d_band2", w: 64, h: 64, top: 4, bottom: 60 },
    d_wheel: { img: "d_wheel", w: 64, h: 64, top: 5, bottom: 58, solid: [26, 10] },
    d_bedman: { img: "d_bedman", w: 48, h: 64, top: 5, bottom: 59, solid: [36, 40] },
    d_scope: { img: "d_scope", w: 64, h: 64, top: 3, bottom: 61, solid: [30, 12] },
  };
