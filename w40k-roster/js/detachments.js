...
(() => {
  ...
  const SEED = [
    ...
    },
    {
      ...
      enhancements: [
        { name: "トランスオラキュラー・ダイアド・ウェハー", points: 30, text: "カステラン・ロボット部隊に随伴させると、戦闘終了までその部隊は命令教条の恩恵と「ヘイローオーバーライド」キーワードを得る（その部隊はノウアスフィア転写の対象選択には使えなくなる）。", restrict: "サイバネティカ・データスミス" },
