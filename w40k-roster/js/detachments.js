  ...
  const SEED = [
    {
      ...
      enhancements: [
        ...
        { name: "オートクレイヴの断罪", points: 15, text: "装備者の射撃武器は「対歩兵2+」「対モンスター4+」を得る。", modifiers: [{ kind: "keyword", scope: "ranged", value: "対歩兵2+" }, { kind: "keyword", scope: "ranged", value: "対モンスター4+" }] },
      ],
      stratagems: [
        { name: "禍々しき光輪", cost: 2, phase: "格闘フェイズ、敵ユニットが目標を選択した直後", text: "選択された友軍帝国技術局ユニット（乗物除く。バトルラインなら6インチ以内の友軍スキタリイも追加可）を対象。ターン終了まで、それを狙う攻撃のウーンドロールに-1。" },
        { name: "殲滅命令", cost: 1, phase: "あなたの指揮フェイズ", text: "24インチ以内の目標物範囲内の敵ユニットごとにD6、4+で致命傷1とバトルショックテストを強制。" },
        { name: "攻撃命令", cost: 1, phase: "あなたの移動フェイズ", text: "まだ移動していない友軍スキタリイ部隊（バトルラインなら6インチ以内の友軍スキタリイも追加可）を対象。そのフェイズの間、前進の際ロールせず、代わりに移動特性+6インチ。" },
        { name: "事前較正殲滅解", cost: 1, phase: "あなたの射撃フェイズ", text: "まだ射撃していない友軍帝国技術局ユニット（バトルラインなら6インチ以内の友軍スキタリイも追加可）を対象。相手配置エリア内の敵を狙う射撃攻撃は命中ロールをリロール可。" },
        { name: "致死量投与", cost: 1, phase: "あなたの射撃フェイズ", text: "まだ射撃していない友軍帝国技術局ユニットを対象。そのフェイズの間、射撃武器は「会心ヒット」を得る。" },
        { name: "防壁命令", cost: 2, phase: "相手の射撃フェイズ、敵ユニットが目標を選択した直後", text: "選択された友軍スキタリイ部隊（バトルラインなら6インチ以内の友軍スキタリイも追加可）を対象。そのフェイズの間、特防4+を得る。" },
      ],
    },
    {
      ...
      stratagems: [
        ...
        { name: "分析による占術", cost: 1, phase: "相手の移動フェイズ、敵ユニットが移動を終えた直後", text: "その敵の8インチ以内・交戦距離外の友軍帝国技術局歩兵ユニット（カタフロン除く）を対象。通常移動D6インチ（ヘイローオーバーライドユニットなら6インチ）が可能。" },
      ],
    },
    {
      name: "スキタリイ・ハンター・コホート",
      forceType: "",
      dp: 2,
      rule: "隠密最適化: 友軍のスキタリイ歩兵・スキタリイ騎乗・アイアンストライダー・バリスタリイは隠密能力を持つ。",
      enhancements: [
        { name: "詠唱スロールネット", points: 25, text: "バトルラウンド開始時、12インチ以内の友軍スキタリイ部隊を1つ選択。次のバトルラウンド開始まで、その部隊は迎撃命令・征服命令の両方が有効。", restrict: "スキタリイ・マーシャル" },
        { name: "隠密の潜入者", points: 15, text: "装備者、およびその率いる部隊は「浸透戦術」と「斥候6インチ」を得る。", restrict: "スキタリイ" },
        { name: "覆いを纏う狩人", points: 10, text: "両陣営の配置完了後、友軍スキタリイ歩兵部隊を最大3つ再配置可能。その際、戦略予備の上限にかかわらず戦略予備に入れられる。", restrict: "スキタリイ・マーシャル" },
        { name: "戦域中継アップリンク", points: 25, text: "射撃フェイズに装備者の部隊が射撃した後、交戦距離外なら通常移動6インチ可能（その場合そのターンはチャージ不可）。", restrict: "スキタリイ" },
      ],
      stratagems: [
        { name: "生体機械の忍耐", cost: 1, phase: "相手の射撃フェイズまたは格闘フェイズ、敵ユニットが目標を選択した直後", text: "選択された友軍シカリアン/プテラクシイ/シドニアンユニットを対象。そのフェイズの間、「痛みを知らぬ者5+」を得る。" },
        { name: "二進法の攻勢", cost: 2, phase: "あなたの射撃フェイズまたは格闘フェイズ開始時", text: "まだ射撃・格闘していない友軍スキタリイ2部隊と敵ユニット1つを対象。そのフェイズの間、両部隊の武器の貫通値+1（ただしその敵ユニット以外を対象にできなくなる）。" },
        { name: "迅速な粛清プロトコル", cost: 1, phase: "あなたのチャージフェイズ", text: "友軍スキタリイユニットを対象。そのフェイズの間、前進したターンでもチャージ宣言可。" },
        { name: "分離撃滅", cost: 1, phase: "あなたの射撃フェイズ", text: "まだ射撃していない友軍シカリアン/プテラクシイ/シドニアン/アイアンストライダー・バリスタリイ/スキタリイ騎乗ユニットを対象。そのフェイズの間、狙った敵の6インチ以内に他の敵がいなければウーンドロールに+1。" },
        { name: "遮蔽プロトコル", cost: 1, phase: "相手の射撃フェイズ、敵ユニットが目標を選択した直後", text: "選択された友軍スキタリイ歩兵ユニットを対象。そのフェイズの間、18インチ以上離れたモデルからは狙われない。" },
        { name: "計画的撤収", cost: 1, phase: "相手の格闘フェイズ終了時", text: "友軍シカリアン最大2部隊、またはスキタリイ歩兵/騎乗1部隊を対象（全モデルが敵から3インチ以上離れていること）。盤上から取り除き戦略予備に戻す。" },
      ],
    },
    {
      name: "データ詠唱コンクラーベ",
    ...
    },
    {
      ...
      stratagems: [
        ...
        { name: "香煙排気", cost: 1, phase: "相手の射撃フェイズ、敵ユニットが目標を選択した直後", text: "選択された友軍帝国技術局歩兵ユニットと、6インチ以内の友軍SMOKEユニットを対象。そのフェイズの間、両方とも隠密能力と遮蔽の恩恵を得る。" },
        { name: "反応的防護", cost: 1, phase: "相手のチャージフェイズ、敵がチャージを宣言した直後", text: "チャージされた確保目標範囲内の友軍帝国技術局歩兵ユニットと6インチ以内の友軍トランスポートを対象（全モデルがそのトランスポートの3インチ以内かつ収容枠が十分な場合）。そのトランスポートに乗車できる。" },
      ],
    },
    {
      name: "コホート・サイバネティカ",
      ...
      enhancements: [
        ...
        { name: "大否定者", points: 5, text: "装備者の射撃武器は「対乗物4+」を得る。", restrict: "テックプリースト", modifiers: [{ kind: "keyword", scope: "ranged", value: "対乗物4+" }] },
      ],
      stratagems: [
    ...
    },
    {
      ...
      forceType: "",
      dp: 2,
      rule: "殺戮命令: 友軍スキタリイ・ユニットの攻撃時、迎撃命令が有効なら命中ロールの1をリロール可、征服命令が有効ならウーンドロールの1をリロール可。",
      enhancements: [
        { name: "万物思考機関", points: 25, text: "装備者の部隊は征服命令と迎撃命令の両方が常時有効。", restrict: "スキタリイ・マーシャル" },
        ...
        { name: "オムニシアの激怒", points: 10, text: "装備者の白兵武器の攻撃回数+2、貫通値・ダメージそれぞれ1向上。", restrict: "スキタリイ・マーシャル" },
      ],
      stratagems: [
        ...
        { name: "解放された怒り", cost: 1, phase: "あなたの射撃フェイズ", text: "まだ射撃していない友軍スキタリイユニットを対象。そのフェイズの間、射撃武器に「連続命中1」または「会心ヒット」（もしくは両方＋「危険」）を付与できる。" },
        { name: "脅威演算照準機", cost: 1, phase: "あなたの射撃フェイズ", text: "まだ射撃していない友軍スキタリイ乗物ユニットを対象。そのフェイズの間、モンスター/乗物への射撃ダメージロールをリロール可。" },
        ...
        { name: "分析による反撃", cost: 1, phase: "相手の射撃フェイズ、敵が射撃した直後", text: "その攻撃でモデルを失った友軍スキタリイ歩兵ユニットを対象。自分の射撃フェイズであるかのように射撃可能（その敵ユニットのみを対象にできる場合に限る）。" },
      ],
    },
  ];
