(function () {
  ...
  const NPCS = [
    ...
    },
    {
      id: "tanukichi",
      name: "たぬきち",
      sprite: "../tanukichi/assets/tanukichi_sprite_sheet.png",
      x: 255,
      y: 510,
      roof: "#8a6a42",
      wall: "#f2e9d6",
      ...
      isAlly: false,
      magic: "water",
      preLine: "化かしてやるから、覚悟しな!",
      lowHpLine: "ま、まって!とっておきの酒を 一杯 おごるから……!",
      deathLine: "た、たぬき寝入りだ……",
      dropItem: { name: "たぬきの化け葉", hpBonus: 4, atkBonus: 2 },
      lines: ["たぬきの化かし技、見せてあげようか?", "一緒に町を見回ろうよ!"],
      graveLines: ["……。", "たぬき寝入りから まだ さめない……"],
    },
  ];
